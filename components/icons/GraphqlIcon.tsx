...
interface StyledGraphqlIconProps {}

const StyledGraphqlIcon = styled.div<StyledGraphqlIconProps>`
	padding: 0 5px;
`;

interface GraphqlIconProps extends Props<any> {}

const GraphqlIconDefaultProps: GraphqlIconProps = {};

const GraphqlIcon: React.FC<GraphqlIconProps> = ({}) => {
   return (
      <StyledGraphqlIcon>
         <svg stroke="#fff" fill="#fff" width="1em" height="1em" viewBox="0 0 400 400">
            <g>
               <g>
                  <g>
                     <rect
...
export default withDefaultProps<GraphqlIconProps>(GraphqlIcon, GraphqlIconDefaultProps);
